...
<div id="pageAll">
    ...
    <div class="page">
        ...
        <div class="banner">
            <div class="add">
                <a class="addA" href="/cate/add">添加分类信息&nbsp;&nbsp;+</a>
            </div>
            <!-- banner 表格 显示 -->
            <div class="banShow">
                <table border="1" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="315px" class="tdColor">分类名称</td>
                    ...
                    @foreach($data as $k=>$v)
                        <tr>
                            <td>{{$v->id}}</td>
                            <td>{{$v->cate_name}}</td>
                            <td ><span class="is_no" >{{$v->is_show}}</span><input type="text" class="hid" data-id="{{$v->id}}"></td>
                            <td><a href="{{url('/cate/update',$v->id)}}"><img class="operation update"
